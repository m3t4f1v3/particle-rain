...
dependencies {
    ...
    modCompileOnly("maven.modrinth:mafglib:${property("deps.mafglib")}")
    modRuntimeOnly("maven.modrinth:mafglib:${property("deps.mafglib")}")
    modCompileOnly("maven.modrinth:servuxforged:${property("deps.servuxforged")}")
    // modRuntimeOnly("maven.modrinth:servuxforged:${property("deps.servuxforged")}")
